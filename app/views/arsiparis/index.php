        ...
        <div class="col-12 col-lg-12 col-md-12">
            <div class="card mycard">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <!-- Judul -->
                    <h6 class="m-0 font-weight-bold"><?= $dataSimpanPinjam['SubJudulArsiparis']; ?> Peminjaman</h6>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
    ...
    <div class="row">
        <div class="col-12 col-lg-8 col-md-8">
            <div class="card mycard">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <!-- Judul -->
                    <h6 class="m-0 font-weight-bold"><?= $dataSimpanPinjam['SubJudulArsiparis']; ?> Grafik Dokumen</h6>
        ...
        <div class="col-12 col-lg-4 col-md-4">
            <div class="card mycard">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <!-- Judul -->
                    <h6 class="m-0 font-weight-bold"> <?= $dataSimpanPinjam['SubJudulArsiparis']; ?> Total Data</h6>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-12 col-lg-12 col-md-12">
