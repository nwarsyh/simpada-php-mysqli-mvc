                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-sm dataTable-table" id="tableAnwar">
                        ...
                        <tr class="text-center">
                            ...
                            <!--END PINJAM DOAPPROVE-->
                            <!--START PINJAMAN DITOLAK-->
                            ...
                            <!--END PINJAMAN DITOLAK-->
                            <!--START DETAIL PINJAMAN-->
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-2">
                                ...
                                <div id="dokumenDetails" style="display:none;">
                                    <!--kalau pakai class table-hover pas tampilan dark sebagian data tabel ga muncul-->
