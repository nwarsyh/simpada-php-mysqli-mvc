<!--START MENU DAN KONTEN-->
<div id="layoutSidenav">
    <!--START menu sebelah kiri-->
        ...
        <nav class="sb-sidenav accordion" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav mt-3">
                    ...
                    <a class="nav-link" href="<?= BASEURL; ?>/BackupDatabase/BackupDatabase">
                        <div class="sb-nav-link-icon">
                            <i class="bi bi-send-plus"></i></div>
                        Backup Database
                    </a>
