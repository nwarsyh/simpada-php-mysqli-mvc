        ...
        <div class="card-body login-card-body">
            ...
            <form action="<?= BASEURL; ?>/SignIn/doRegistrasiKaryawan" method="post">
                <div class="input-group input-group-sm mb-3">
                    <input name="nama_depan" id="nama_depan" type="text" class="form-control" placeholder="Nama Depan" />
                    <div class="input-group-text">
                        <span class="bi bi-person"></span>
                    </div>
                </div>
                <div class="input-group input-group-sm mb-3">
                    <input name="nama_belakang" id="nama_belakang" type="text" class="form-control" placeholder="Nama Belakkang" />
                    <div class="input-group-text">
                ...
                <div class="input-group input-group-sm mb-3">
                    <input name="password_awal" id="password_awal" type="password" class="form-control" placeholder="Password" />
                    <div class="input-group-text">
                        <span class="bi bi-lock"></span>
                    </div>
                </div>
                <div class="input-group input-group-sm mb-3">
                    <input name="password_ulang" id="password_ulang" type="password" class="form-control" placeholder="Password" />
                    <div class="input-group-text">
            ...
            <div class="row mb-1">
                <div class="col-6">
                    <a href="<?= BASEURL; ?>/SignIn" class="text-decoration-none text-danger">Kembali Login</a>
                </div>
                <!-- /.col -->
