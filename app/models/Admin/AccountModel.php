...
class AccountModel extends BaseModel
{
    ...
    public function hapusDataAccount($hapusDataAccount)
    {
        ...
        //cek idi sudah dapat atau belum
        //var_dump($UserYgDiHapus);
        //die();

//        // cek id sudah diperoleh atau belum
        if (!$AccountYangDihapus){
            return false;
        }
//
//        // Ambil id_karyawan dari ref user
        $refUser = $AccountYangDihapus['id_karyawan'];
//        // Reset id_user di tabel_karyawan jadi 0 / NULL
