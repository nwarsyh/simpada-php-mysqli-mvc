...
class Karyawan extends Controller
{
    ...
    {
        $dataSimpanPinjam['JudulWeb'] = 'SIMPADA | Master Karyawan';
    ...
    {
        $dataSimpanPinjam['JudulWeb'] = 'SIMPADA | Tambah Karyawan';
    ...
    {
        $dataSimpanPinjam['JudulWeb'] = 'SIMPADA | Ubah Karyawan';
    ...
    {
        $dataSimpanPinjam['JudulWeb'] = 'SIMPADA | Detail Karyawan';
